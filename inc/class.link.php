...
class LinkIcon {
  ...
  protected $LinkArrow = '<svg version="1.1" id="Ebene_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
  ...
  public function getLinkIcon($LinkURL, $LinkText, $Target = '_self' ) {
    $this->icon = '<a href="'.$LinkURL.'" target="'.$LinkText.'" title="'.$LinkText.'"><div class="se-link clearfix">';
		$this->icon .= $this->LinkArrow.'<p class="se-link-text se-mc-txt">'.$LinkText.'</p></div></a>';
    return $this->icon;
  }
