...
class SpeakerClass {
  ...
  public function getSpeaker($Pid = 'N'){
    if($Pid == 'N') {  //check require parameter
      ...
      $this->outputSpeaker = '<div class="se-col-8">';
      ...
      $this->outputSpeaker .= '<div class="se-col-4 se-sc-bg se-wc-txt" style="display:table;min-height:300px;">';
  ...
  public function getSpeakerReview($Pid = 'N'){
    if($Pid == 'N') {  //check require parameter
      ...
      $this->outputReview = '<div class="se-strip se-speaker-review se-sc-bg"><div class="se-content">';
      ...
      $this->outputReview .= '<div class="se-col-5 se-wc-txt">';
      ...
      $this->outputReview .= '<iframe width="100%" height="100%" src="https://media10.simplex.tv/content/73/4595/101725/index.html?embed=1" frameborder="0" allowfullscreen="true" webkitallowfullscreen="true" mozallowfullscreen="true" scrolling="no"></iframe>';
      ...
      for ($c=0; $c < count($reviewIMG); $c++) {
        ...
        $ce = $c+1;
        $this->outputReview .= '<div counter="'. $ce .'" class="se-gallery-pic image-settings" style="background-image:url('.$reviewIMGurl.');">';
        $this->outputReview .= '</div>';
      }
      $this->outputReview .= '</div></div></div>';
